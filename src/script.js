...
for (let i = 0; i < 50; i++){
    const angle = Math.random() * Math.PI * 2 // 360 spread
    const radius = 3 + Math.random() * 6  //starting from 3(away from house) up to
...
// Ghosts
const ghost1 = new THREE.PointLight('#53ad80', 2, 3)
scene.add(ghost1)
